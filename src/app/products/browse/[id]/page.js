...
export default function ProductDetailPage() {
  ...
  const { browseProducts } = browseStore();
  useEffect(() => {
    if (browseProducts) {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className=" h-[137px] w-full flex items-center justify-between px-[50px]">
        ...
        <button
          ...
          className="rounded-md  border border-[#18181866] h-fit w-fit grid place-content-center"
        >
        ...
        <div className=" bg-gray-100">
          ...
          <div className="relative  mb-[84px] mx-[95px]   w-auto h-[719px] bg-gray-100 rounded-lg overflow-hidden">
            <Image
              ...
              fill
              className="object-contain brightness-110  mix-blend-multiply   h-full w-full"
              priority
              ...
              <div className=" flex no-scrollbar overflow-x-auto gap-[19px]">
                {images.map((image, index) => (
                  <button
                    ...
                    } h-[160px] flex-shrink-0 w-[160px] border border-[#D4D4D4] bg-white rounded-[24px] overflow-hidden  transition-all 
        ...
        <div className="   flex flex-col justify-between w-full h-[580px]">
          <div className=" ">
            ...
            <div className=" px-[100px]">
              <p className=" text-[24px] mt-1.5 max-w-full  line-clamp-4 leading-[45px] text-[#000]">
                {product?.shopifyData?.metafields?.bottom_description?.value ||
                  ""}
              </p>
            </div>
            <div>
              <div className=" flex no-scrollbar  gap-[24px] mt-[35px] overflow-x-auto">
          ...
          <PersonalTouch
            ...
            isOpen={PrsTouch}
            product={product}
            href={`/products/browse/${product?.pineconeMetadata?.productHandle}/choose-greeting-templates`}
          />
        </div>
      </main>
    </div>
