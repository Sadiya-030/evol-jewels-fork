...
import SkipGreetingModal from "../../../../../components/ui/SkipGreetingModal";
const page = () => {
  ...
  const thirdLast = parts2[2];
  const str = window.location.href;
  const parts = str.split("/").filter(Boolean); // ["sdf", "sdfs", "sdfsf", "sdfsdf"]
  const secondLast = parts[parts.length - 2];
  const { product, selectedCard, setSelectedCard } = useGreetingStore();
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="  relative z-20">
        <div className=" h-[137px] border-b border-[#CECECE] w-full flex items-center justify-between px-[50px]">
          ...
          <button
            ...
            className=" border border-[#18181866] h-fit w-fit grid rounded-md place-content-center"
          >
        ...
        <div className=" flex flex-col justify-between h-[1775px] pt-[100px] ">
            ...
            <div>
              ...
              <div className=" w-full items-center  flex gap-[60px]">
                <div className=" h-[396px] relative flex-shrink-0 w-[322px] p-3  rounded-[30px] border border-[#C6C2EC]">
                  <div className=" overflow-hidden bg-white border  border-[#E1E1E1] rounded-3xl h-full w-full">
                    <img
                ...
                <div className=" w-full">
                  ...
                  <button
                    onClick={() => {
                      router?.push(
                        `/products/browse/${product?.product?.pineconeMetadata?.productHandle}`
                      );
                    }}
              ...
              <div className=" pt-32">
                ...
                <p
                  onClick={() => {
                    ...
                    router.push(
                      `/${last2}/${secondLast2}/${thirdLast}/choose-greeting-templates`
                    );
                  }}
          ...
          <div className=" px-[100px]  pb-[20px] pt-[38px] items-center border-t bg-[#FFFFFF] border-[#D4D4D4] justify-between  flex w-full">
            ...
            <p
              ...
              className=" bg-[#002066] text-white rounded-[200px] h-[77px] w-[240px] text-[30px] flex items-center justify-center"
            >
              View My Gift
            </p>
          </div>
      ...
      {/* <BottomSheet isOpen={editTemp} onClose={() => seteditTemp(false)} /> */}
    </div>
  );
};
