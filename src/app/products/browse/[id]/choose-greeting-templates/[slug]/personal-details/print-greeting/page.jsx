  ...
  const printGreeting = () => {
    ...
    <html>
      ...
      <body onload="window.print(); window.close();">
        <div class="card">
          <img src="${selectedCard?.img?.url}" />
          <div class="overlay">
            <div class="content">
              ${
                selectedCard?.theirName
                  ? `<div class="title">For ${selectedCard?.theirName}</div>`
                  : ""
              }
      ...
      <div className="  relative z-20">
        <div className=" h-[137px] border-b border-[#CECECE] w-full flex items-center justify-between px-[50px]">
          ...
          <button
            ...
            className=" border border-[#181818dc] h-fit w-fit rounded-md grid place-content-center"
          >
        ...
        <div className=" flex flex-col justify-between h-[1775px] pt-[100px] ">
                  ...
                  <div className=" relative">
                    ...
                    <div className=" absolute flex items-center flex-col justify-center top-0 left-0 w-full h-full object-cover ">
                      <div className=" flex flex-col justify-center items-center gap-3">
                        {selectedCard?.theirName && selectedCard?.yourName && (
                        ...
                        {selectedCard?.yourName && selectedCard?.yourName && (
          ...
          <div className=" px-[100px]  pb-[20px] pt-[38px] items-center border-t bg-[#FFFFFF] border-[#D4D4D4] justify-between  flex w-full">
            ...
            <button
              ...
              className=" bg-[#002066] text-white rounded-[200px] h-[77px] w-[283px] text-[30px] flex items-center justify-center"
            >
              Print greeting
            </button>
          </div>
