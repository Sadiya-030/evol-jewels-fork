...
const page = () => {
  ...
  const newParts2 = parts2.slice(0, -1).join("/");
          ...
          <div className="  px-[53px]">
              ...
              <div className=" w-full items-center  flex gap-[60px]">
                ...
                <div className=" w-full">
                  ...
                  <button
                    onClick={() => {
                      router?.push(
                        `/home/birthstone/your-birthstone/browse/${product?.product?.pineconeMetadata?.productHandle}`
                      );
                    }}
            ...
            {product?.isSkip ? (
              <div className=" pt-32">
                ...
                >
                  {/* Add Greeting <GoArrowRight size={34} /> */}sfwre
                </p>
              </div>
            ) : (
              <div>
