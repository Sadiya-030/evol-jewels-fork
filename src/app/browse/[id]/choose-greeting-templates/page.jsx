...
const page = () => {
  const { product, setProduct, setSelectedCard } = useGreetingStore();
    ...
    <div className=" relative">
      ...
      <div className="min-h-screen h-full w-full  relative z-50 bg-white/70">
        <div className=" h-[137px] border-b border-[#CECECE] w-full flex items-center justify-between px-[50px]">
          ...
          <Link
            href="/home"
            className="rounded-md text-xl text-black border-black px-3 py-2 grid place-content-center"
          >
            Home
          </Link>
        </div>
        ...
        <div className=" px-[100px] flex flex-col  h-fit  gap-6 items-center">
          ...
          <p
            onClick={() => {
              ...
              router.push(`/browse/${secondLast}/print-greeting`);
            }}
